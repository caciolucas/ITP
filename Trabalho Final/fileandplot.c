/**
 * @file fileandplot.c
 * @brief Implementação das funções relacionadas a manipulação dos arquivos de saída e entrada
 * @details Define a função que lê o arquivo de parâmetros, a que escreve no
